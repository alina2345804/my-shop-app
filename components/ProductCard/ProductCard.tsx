...
export const ProductCard = ({
  ...
  const { name, price, discount, images, isSoldOut, oldPrice } = product;
      ...
      >
        <div className={styles.productImage}>
          <Image
            ...
            // Это закомментила, так как вопрос с адаптацией
          />
          ...
          {/*  {discount && !isSoldOut && (*/}
          {/*    <span className={styles.tagDiscount}>-{discount}%</span>*/}
          {/*  )}*/}
