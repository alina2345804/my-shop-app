...
import styles from '@/components/Sections/AboutUs/AboutUs.module.css';
import Beads from '@/components/Sections/SectionAbout/beads.png';
import Hands from '@/components/Sections/SectionAbout/hands.png';
